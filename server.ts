...
// Lazy-initialize Gemini AI client only when needed
...
// Local fallback knowledge engine when API key is unconfigured or offline
...
// 3. Mount Vite Middleware for Dev and Static Files for Production
